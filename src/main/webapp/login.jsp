...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" charset="utf-8" type="text/css" href="css/login.css"/>
		<title>测试</title>
		<script type="text/javascript" src="js/common/jquery-1.9.1.min.js"></script>
		<script type="text/javascript" src="js/common/newproperty_common.js"></script>
	</head>

	<body>
		<div id= "container">
				<form id="form" method="post" action="user/login.do">
				<div align="center">
